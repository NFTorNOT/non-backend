const rootPrefix = '../..',
  ...
  signatureConfig = require(rootPrefix + '/config/apiParams/signature');
...
class ApiParamsValidator {
  ...
  async _fetchParamsConfig() {
    ...
    const versionConfig = signatureConfig;
    ...
    if (oThis.paramErrors.length > 0) {
      return Promise.reject(
        responseHelper.paramValidationError({
          ...
          error_config: basicHelper.fetchErrorConfig(oThis.dynamicErrorConfig),
          debug_options: {}
        })
      );
    }
